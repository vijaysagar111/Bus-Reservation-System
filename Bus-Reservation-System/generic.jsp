		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					...
					<header class="major">
						<center><i><font size="35"><strong>Hello SAGAR </font></i></strong></center>
						<br>
...
-->				</div>
			...
			<form action="bus_details1.jsp" method="POST">
...
<a href="#" class="image fit"><img src="images1/bus3.jpg" alt="" /></a>
		...
		<!-- Footer --><footer id="footer">
			...
			<!--				<ul class="icons">
					...
					<ul class="copyright">
						<li>&copy; 2019 OnlineBusReservation. All rights reserved. </li>
