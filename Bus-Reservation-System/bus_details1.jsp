		...
		<!-- Main -->
			<section id="main" class="wrapper">
				<div class="container">
					...
					<header class="major">
						<center><i><font size="35"><strong>Hello  </font></i></strong></center>
						<br>
...
st=con.createStatement();
 String str1=request.getParameter("Origin");
 String str2=request.getParameter("Destination");
 String qry="select * from booking where origin = 'vizag' and destination = 'vijayawada'";

  if(str1.equalsIgnoreCase("vizag") && str2.equals("vijayawada"))
...
<td><a href="payment1.php?Seats_no='.$req.'& Bus_id='.$Bus_id.'& Total_fare='.$Total_fare.'">Book Now</a></td>
</tr>
<%
}
